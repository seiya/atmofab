...
- Every drift scenario — spec_ref replacement / deps.yaml edit / spec_catalog.yaml drift / a dependency artifact revoked or re-derived after the mark — is refused at the gate by the live recompute, whatever the record says.
