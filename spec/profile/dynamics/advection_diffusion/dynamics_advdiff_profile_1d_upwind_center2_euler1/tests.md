...
- The normal-case `component` versions use the following.
  - `dynamics_advdiff_flux_1d_upwind_center2@0.2.0`
  - `dynamics_advection_diffusion_boundary_1d_periodic_copy@0.2.0`
  - `dynamics_advection_diffusion_time_update_1d_euler1@0.2.0`
