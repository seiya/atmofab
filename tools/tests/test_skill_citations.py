...
class CitationScannerSelfTests(unittest.TestCase):
    ...
    _SOURCE = f"{SKILL_ROOT}/atmofab-enforcement-change/SKILL.md"
    ...
    def test_top_level_files_and_skill_relative_pointers_are_in_scope(self) -> None:
        ...
        self.assertCountEqual(
            targets,
            ["AGENTS.md", "TODO.md",
             f"{SKILL_ROOT}/atmofab-enforcement-change/references/verification.md"])

    def test_a_skill_relative_pointer_resolves_from_a_reference_file_too(self) -> None:
        source = f"{SKILL_ROOT}/atmofab-enforcement-change/references/verification.md"
        self.assertEqual(
            citation_targets("`scripts/measure_claude_tool.py`", source),
            [f"{SKILL_ROOT}/atmofab-enforcement-change/scripts/measure_claude_tool.py"])
