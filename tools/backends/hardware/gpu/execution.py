...
ran on. `Validate.execute` runs it where the binary runs — at the execution site, before the first
command — and records that line as `trial_meta.json#environment.platform.gpu`: a record, not a
