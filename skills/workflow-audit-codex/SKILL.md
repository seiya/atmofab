...
> `~/.met-forge/homes/<orch_id>/codex`, which is why this audit works at all after a host
...
> credential/session home and, since issue #64, `~/.met-forge` — so the guard rejects these
