...
(PR #187 froze the comparison out of the suite on 2026-09-06, and the second target's first pull
request, issue #289, restored it; while it was frozen no commit demanded a regeneration. With it
back in the suite, normal operation hits the remedy again — the episode's hazard is live.)
