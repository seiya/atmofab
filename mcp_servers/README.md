...
- The type rules apply in both modes: `target` must be a string and `extra_args` an array of strings; a non-string element is refused rather than coerced.
